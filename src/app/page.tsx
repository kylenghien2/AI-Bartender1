    ...
    <div>
      ...
      <div style={{ display:'grid', gap:12 }}>
        <textarea
          ...
          onChange={onMood}
          rows={3}
          style={{ background:'#ffffff', color:'#0b1220', border:'1px solid #e5e7eb', borderRadius:12, padding:12 }}
        />
        <div style={{ display:'flex', gap:8 }}>
          <select
            value={base}
            onChange={onBase}
            style={{ background:'#ffffff', color:'#0b1220', border:'1px solid #e5e7eb', borderRadius:10, padding:10 }}
          >
          ...
          <input
            ...
            style={{ flex:1, background:'#ffffff', color:'#0b1220', border:'1px solid #e5e7eb', borderRadius:10, padding:10 }}
          />
        </div>
        <input
          value={occasion}
